...
class DataTransformation:
    ...
    def get_data_transformer_object(self) -> ColumnTransformer:
        """
            This method is responsible for creating and configuring a data transformer object
            that can be used to preprocess numerical and categorical data for machine learning
            tasks. It combines imputation, scaling, and one-hot encoding for the specified
            columns.

            Returns:
                preprocessor (sklearn.compose.ColumnTransformer): A scikit-learn ColumnTransformer 
                object that can be used to preprocess numerical and categorical data
        """
        try:
        ...
        '''
            ...
            Returns:
                A tuple containing the following elements:
                    ...
                    preprocessor_obj_file_path (str): File path where pickle file are saved
        '''
        try:
